    ...
    public Docket goodsApi() {
        ...
        return new Docket(DocumentationType.OAS_30)
                .apiInfo(new ApiInfoBuilder()
                        ...
                        .build())
                .select()
                .apis(basePackage("com.enlightenment.demo.controller.goods"))
                .paths(PathSelectors.any())
    ...
    public Docket transactionApi() {
        ...
        return new Docket(DocumentationType.OAS_30)
                .apiInfo(new ApiInfoBuilder()
                        ...
                        .build())
                .select()
                .apis(basePackage("com.enlightenment.demo.controller.transaction"))
                .paths(PathSelectors.any())
    ...
    public Docket aftermarketApi() {
        ...
        return new Docket(DocumentationType.OAS_30)
                .apiInfo(new ApiInfoBuilder()
                        ...
                        .build())
                .select()
                .apis(basePackage("com.enlightenment.demo.controller.aftermarket"))
                .paths(PathSelectors.any())
