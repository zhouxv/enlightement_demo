...
import com.qingyan.demo.dto.DataSetDTO;
...
import static com.qingyan.demo.dto.DataSetDTO.toGetDataSet;

/**
 * 用户数据集管理 controller.
 *
 * @author zhouxv 2021/7/21.
 */
@Slf4j
...
public class DataSetManagement {
     ...
     * 数据集所有权声明接口
     *
     * @param sampleData MultipartFile
     * @param dataSetDTO DataSetDTO
     * @return
     * @apiNote 传入数据集基本信息、数据集和sample的哈希签名，以及上传sample文件
     */
    @PostMapping({"claim"})
